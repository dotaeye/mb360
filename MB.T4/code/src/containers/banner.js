...
var Banner = React.createClass({
  ...
  onEdit(record){
    this.props.bannerActions.getById(record.id).then((err)=> {
      if (err) {
        message.error('获取Banner数据失败！请刷新页面尝试。');
      }
      else {
        this.setState({
          visible: true,
      ...
      <div className='container'>
        <div className='ant-list-header' data-flex="dir:right">
          <div className='ant-list-header-right'>
            <Button type="primary" icon="plus" onClick={this.onAdd}>添加Banner</Button>
          </div>
        </div>
        <Table
          ref='table'
...
Banner = createForm()(Banner);

export default connectStatic(statics)(connect(mapStateToProps, mapDispatchToProps)(Banner))
