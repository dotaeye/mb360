...
{
	public class ProductAttributeValueProfile : BaseProfile
    {
        public ProductAttributeValueProfile() : base("ProductAttributeValueProfile")
        {
        }
...
;
			...
			CreateMap<ProductAttributeValueDTO, ProductAttributeValue>()
					...
					.ForMember(entity => entity.ProductAttributeMapping, o => o.Ignore())
;
        }
    }
}
