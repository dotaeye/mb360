...
{
	public class CarCateProfile : BaseProfile
    {
        public CarCateProfile() : base("CarCateProfile")
        {
        }
		...
		protected override void CreateMaps()
        {
			...
			CreateMap<CarCate, CarCateDTO>()
;

			 
			CreateMap<CarCateDTO, CarCate>()
					...
					.ForMember(entity => entity.ParentCarCate, o => o.Ignore())
					.ForMember(entity => entity.ChildCarCate, o => o.Ignore())
;
        }
    }
}
