...
import * as productManufacturerActions from '../actions/productManufacturer'
...
var ProductManufacturer = React.createClass({

  displayName: 'ProductManufacturer',
  ...
  fetchData(page){
    this.props.productManufacturerActions.getAll({
  ...
  onRemove(record){
    const self = this;
    const { productManufacturer:{ list }} = this.props;
  ...
  onModalSubmit(){
    ...
    const { update, create} =this.props.productManufacturerActions;
    const { entity }= this.props.productManufacturer;
  ...
  render() {
    ...
    const { productManufacturer:{ loading, list, entity }} = this.props;
...
function mapStateToProps(state) {
  return {
    auth: state.auth,
    productManufacturer: state.productManufacturer
  }
}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    productManufacturerActions: bindActionCreators(productManufacturerActions, dispatch)
  }
}
...
ProductManufacturer = createForm()(ProductManufacturer);

export default connectStatic(statics)(connect(mapStateToProps, mapDispatchToProps)(ProductManufacturer))
