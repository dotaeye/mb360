...
var OrderPrint = React.createClass({
  ...
  render() {
    ...
    return (
      <div className='container' style={{'margin':'0 auto',width:'600px'}}>
          ...
          <div className="ant-table ant-table-large ant-table-bordered">
            <div className="ant-table-body ant-table-bordered">
              <table>
                ...
                <tr>
                  <th colSpan="2">订单详情<span
                    style={{"float":"right"}}>下单时间： {moment(entity.createTime).format("YYYY-MM-DD HH:mm:ss")}</span>
                  </th>
                </tr>
                </thead>
                ...
                <tr className="ant-table-row">
                  <td colSpan="2">
                    <span style={{'float':'right'}}>
                     <Button type="primary" icon="print" size="large" onClick={()=>{
                        window.print()
                     }} style={{marginRight:'10px'}}>打印出货单</Button>
                    </span>
                  </td>
                </tr>
...
export default connectStatic(statics)(connect(mapStateToProps, mapDispatchToProps)(OrderPrint))
