...
var Job = React.createClass({
  ...
  onModalSubmit(){
    ...
    const { update, create} =this.props.jobActions;
    const { entity }= this.props.job;
  ...
  render() {
    ...
    const { job:{ loading, list, entity }} = this.props;
      ...
      <div className='container'>
        <div className='ant-list-header' data-flex="dir:right">
          <div className='ant-list-header-right'>
            <Button type="primary" icon="plus" onClick={this.onAdd}>添加Job</Button>
          </div>
        </div>
        <Table
          ref='table'
...
export default connectStatic(statics)(connect(mapStateToProps, mapDispatchToProps)(Job))
